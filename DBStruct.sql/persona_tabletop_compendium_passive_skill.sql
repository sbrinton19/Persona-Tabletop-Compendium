...
--
-- Table structure for table `passive_skill`
--
...
CREATE TABLE `passive_skill` (
  ...
  `passiveType` tinyint(2) unsigned NOT NULL,
  `type` tinyint(1) unsigned NOT NULL,
  `value` tinyint(2) unsigned DEFAULT NULL,
  `secondValue` tinyint(2) unsigned DEFAULT NULL,
  PRIMARY KEY (`skillId`),
  UNIQUE KEY `skillId_UNIQUE` (`skillId`),
  CONSTRAINT `passiveSkillId` FOREIGN KEY (`skillId`) REFERENCES `skill` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
