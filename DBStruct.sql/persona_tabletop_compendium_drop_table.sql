...
CREATE TABLE `drop_table` (
  ...
  `isDrop` bit(1) NOT NULL,
  `low` bit(5) NOT NULL,
  `high` bit(5) NOT NULL,
  `isPersona` bit(1) NOT NULL,
  PRIMARY KEY (`itemId`,`sourceId`,`isDrop`,`isPersona`),
  CONSTRAINT `dropItemId` FOREIGN KEY (`itemId`) REFERENCES `item` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
