...
export const specialCombos: Recipe[] = [
    ...
    new Recipe([
        ...
        // personaeMap[PersonaeNameData.SHIKIOUJI], provisionally removing
    ...
    new Recipe([
        ...
        personaeMap[PersonaeNameData.MELCHIZEDEK],
        // personaeMap[PersonaeNameData.LILITH], prvisionally removing
        personaeMap[PersonaeNameData.GABRIEL]
        ],
    personaeMap[PersonaeNameData.SRAOSHA]),
    new Recipe([
        personaeMap[PersonaeNameData.CERBERUS],
        personaeMap[PersonaeNameData.DIONYSUS],
        personaeMap[PersonaeNameData.THANATOS],
        ],
    personaeMap[PersonaeNameData.KRONOS]),
    new Recipe([
    ...
    personaeMap[PersonaeNameData.KOHRYUU]),
    new Recipe([
    ...
    new Recipe([
        personaeMap[PersonaeNameData.SIEGFRIED],
        personaeMap[PersonaeNameData.VALKYRIE]
        ],
    personaeMap[PersonaeNameData.FAFNIR]),
    new Recipe([
        // personaeMap[PersonaeNameData.ANUBIS], provisionally removing
        // personaeMap[PersonaeNameData.ANANTA], provisionally removing
        personaeMap[PersonaeNameData.TRUMPETER],
        personaeMap[PersonaeNameData.MICHAEL],
        personaeMap[PersonaeNameData.METATRON],
