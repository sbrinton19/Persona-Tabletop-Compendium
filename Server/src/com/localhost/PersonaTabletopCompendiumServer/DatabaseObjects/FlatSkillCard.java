...
/**
 * The FlatSkillCard class is the server representation of a SkillCard item
 * Note: currently, there is no side table for FlatSkillCard so this class is a
...
public class FlatSkillCard extends FlatItem {
	 ...
	 *            consumed
	 */
	public FlatSkillCard(int id, String name, byte schedule, String description, String special, ItemType type,
	 ...
	 */
	public FlatSkillCard() {
		initSUIDStrings();
	}

	/**
	 * This constructor is for reading a {@link FlatSkillCard} from the database
	 * 
	 * @param rs
	 *            The {@link ResultSet} pointing to the row to make a
	 *            FlatSkillCard from
	 */
	public FlatSkillCard(ResultSet rs) {
		super(rs);
		fieldReader(rs, FlatSkillCard.class);
	}
	...
	/**
	 * Searches the database for this {@link FlatSkillCard FlatSkillCard's} id
	 * 
	 * @param conn
	...
	/**
	 * This method inserts {@code this} {@link FlatSkillCard} into the item
	 * table
	 * 
	 * @param conn
	 *            A connection to the Database
	...
	/**
	 * This method updates {@code this} {@link FlatSkillCard FlatSkillCard's} entry in the item table
	 * 
	 * @param conn
	 *            A connection to the Database
	 * @returns true if the insert completes successfully with no errors;
